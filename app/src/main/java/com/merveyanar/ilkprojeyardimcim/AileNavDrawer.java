...
public class AileNavDrawer extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_aile_nav_drawer);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.aile_nav_drawer, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.anasayfa_aile) {
            // Handle the camera action
            fragment = new AnasayfaAileFragment();


        } else if (id == R.id.profil_aile) {

            fragment = new ProfilAileFragment();

        } else if (id == R.id.mesajlar_aile) {
