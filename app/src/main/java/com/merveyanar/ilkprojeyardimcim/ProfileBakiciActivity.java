...
public class ProfileBakiciActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_bakici);
    ...
    private void changeEmailOrPasswordFunc(String title, final boolean option) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(
                ProfileBakiciActivity.this);
        final EditText edit = new EditText(ProfileBakiciActivity.this);
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(ProfileBakiciActivity.this, "Şifre değiştirildi.", Toast.LENGTH_LONG).show();
                                    signOutFunc();
                                } else {
                                    edit.setText("");
                                    Toast.makeText(ProfileBakiciActivity.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                                }
                            }
                        });
            }
                ...
                firebaseUser.updateEmail(edit.getText().toString().trim())
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(ProfileBakiciActivity.this, "E-posta değiştirildi.", Toast.LENGTH_LONG).show();
                                    signOutFunc();
